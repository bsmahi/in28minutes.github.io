...
| docker run |  Run a command in a new container | ``$ docker run -p 8080:8080 in28min/hello-world-rest-api:manual``  |
...
| docker rmi  | Remove one or more images by specifying image id  |   |
| docker inspect        | Displays granual level information about Docker object | ``$ docker inspect in28min/hello-world-rest-api:dockerfile1`` |
